...
public class CustomerTable extends TableImpl<CustomerRecord> {
    ...
    private CustomerTable(Name alias, Table<CustomerRecord> aliased, Field<?>[] parameters, Condition where) {
    ...
    public <O extends Record> CustomerTable(Table<O> path, ForeignKey<O, CustomerRecord> childPath, InverseForeignKey<O, CustomerRecord> parentPath) {
     ...
     */
    public static class CustomerPath extends CustomerTable implements Path<CustomerRecord> {
    ...
    @Override
    public TableField<CustomerRecord, LocalDateTime> getRecordTimestamp() {
        return LAST_UPDATE;
    }
    ...
    @Override
    public CustomerTable as(Table<?> alias) {
        return new CustomerTable(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public CustomerTable rename(Table<?> name) {
        return new CustomerTable(name.getQualifiedName(), null);
    }
     ...
     */
    @Override
    public CustomerTable where(Condition condition) {
        return new CustomerTable(getQualifiedName(), aliased() ? this : null, null, condition);
    }
     ...
     */
    @Override
    public CustomerTable where(Collection<? extends Condition> conditions) {
     ...
     */
    @Override
    public CustomerTable where(Condition... conditions) {
        return where(DSL.and(conditions));
    }
     ...
     */
    @Override
    public CustomerTable where(Field<Boolean> condition) {
    ...
    @Override
    @PlainSQL
    public CustomerTable where(SQL condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public CustomerTable where(@Stringly.SQL String condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public CustomerTable where(@Stringly.SQL String condition, Object... binds) {
    ...
    @Override
    @PlainSQL
    public CustomerTable where(@Stringly.SQL String condition, QueryPart... parts) {
     ...
     */
    @Override
    public CustomerTable whereExists(Select<?> select) {
     ...
     */
    @Override
    public CustomerTable whereNotExists(Select<?> select) {
