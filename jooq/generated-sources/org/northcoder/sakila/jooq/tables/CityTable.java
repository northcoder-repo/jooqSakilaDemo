...
import org.northcoder.sakila.jooq.tables.CountryTable.CountryPath;
...
public class CityTable extends TableImpl<CityRecord> {
    ...
    private CityTable(Name alias, Table<CityRecord> aliased, Field<?>[] parameters, Condition where) {
    ...
    public <O extends Record> CityTable(Table<O> path, ForeignKey<O, CityRecord> childPath, InverseForeignKey<O, CityRecord> parentPath) {
     ...
     */
    public static class CityPath extends CityTable implements Path<CityRecord> {
    ...
    @Override
    public TableField<CityRecord, LocalDateTime> getRecordTimestamp() {
        return LAST_UPDATE;
    }
    ...
    @Override
    public CityTable as(Table<?> alias) {
        return new CityTable(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public CityTable rename(Table<?> name) {
        return new CityTable(name.getQualifiedName(), null);
    }
     ...
     */
    @Override
    public CityTable where(Condition condition) {
        return new CityTable(getQualifiedName(), aliased() ? this : null, null, condition);
    }
     ...
     */
    @Override
    public CityTable where(Collection<? extends Condition> conditions) {
     ...
     */
    @Override
    public CityTable where(Condition... conditions) {
        return where(DSL.and(conditions));
    }
     ...
     */
    @Override
    public CityTable where(Field<Boolean> condition) {
    ...
    @Override
    @PlainSQL
    public CityTable where(SQL condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public CityTable where(@Stringly.SQL String condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public CityTable where(@Stringly.SQL String condition, Object... binds) {
    ...
    @Override
    @PlainSQL
    public CityTable where(@Stringly.SQL String condition, QueryPart... parts) {
     ...
     */
    @Override
    public CityTable whereExists(Select<?> select) {
     ...
     */
    @Override
    public CityTable whereNotExists(Select<?> select) {
