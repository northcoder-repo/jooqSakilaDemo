...
import org.northcoder.sakila.jooq.tables.AddressTable.AddressPath;
...
public class StaffTable extends TableImpl<StaffRecord> {
     ...
     */
    public static final StaffTable STAFF = new StaffTable();
    ...
    private StaffTable(Name alias, Table<StaffRecord> aliased) {
        this(alias, aliased, (Field<?>[]) null, null);
    }

    private StaffTable(Name alias, Table<StaffRecord> aliased, Field<?>[] parameters, Condition where) {
     ...
     */
    public StaffTable(String alias) {
    ...
    public <O extends Record> StaffTable(Table<O> path, ForeignKey<O, StaffRecord> childPath, InverseForeignKey<O, StaffRecord> parentPath) {
     ...
     */
    public static class StaffPath extends StaffTable implements Path<StaffRecord> {
    ...
    @Override
    public TableField<StaffRecord, LocalDateTime> getRecordTimestamp() {
        return LAST_UPDATE;
    }

    @Override
    public StaffTable as(String alias) {
        return new StaffTable(DSL.name(alias), this);
    }

    @Override
    public StaffTable as(Name alias) {
        return new StaffTable(alias, this);
    }

    @Override
    public StaffTable as(Table<?> alias) {
        return new StaffTable(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public StaffTable rename(String name) {
        return new StaffTable(DSL.name(name), null);
    }
     ...
     */
    @Override
    public StaffTable rename(Name name) {
        return new StaffTable(name, null);
    }
     ...
     */
    @Override
    public StaffTable rename(Table<?> name) {
        return new StaffTable(name.getQualifiedName(), null);
    }
     ...
     */
    @Override
    public StaffTable where(Condition condition) {
        return new StaffTable(getQualifiedName(), aliased() ? this : null, null, condition);
    }
     ...
     */
    @Override
    public StaffTable where(Collection<? extends Condition> conditions) {
     ...
     */
    @Override
    public StaffTable where(Condition... conditions) {
        return where(DSL.and(conditions));
    }
     ...
     */
    @Override
    public StaffTable where(Field<Boolean> condition) {
    ...
    @Override
    @PlainSQL
    public StaffTable where(SQL condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public StaffTable where(@Stringly.SQL String condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public StaffTable where(@Stringly.SQL String condition, Object... binds) {
    ...
    @Override
    @PlainSQL
    public StaffTable where(@Stringly.SQL String condition, QueryPart... parts) {
     ...
     */
    @Override
    public StaffTable whereExists(Select<?> select) {
     ...
     */
    @Override
    public StaffTable whereNotExists(Select<?> select) {
