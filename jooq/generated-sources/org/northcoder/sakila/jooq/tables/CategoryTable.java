...
public class CategoryTable extends TableImpl<CategoryRecord> {
    ...
    private CategoryTable(Name alias, Table<CategoryRecord> aliased, Field<?>[] parameters, Condition where) {
     ...
     * Create an aliased <code>sakila.category</code> table reference
     */
    public CategoryTable(Name alias) {
        this(alias, CATEGORY);
    }
    ...
    public <O extends Record> CategoryTable(Table<O> path, ForeignKey<O, CategoryRecord> childPath, InverseForeignKey<O, CategoryRecord> parentPath) {
     ...
     */
    public static class CategoryPath extends CategoryTable implements Path<CategoryRecord> {
    ...
    @Override
    public TableField<CategoryRecord, LocalDateTime> getRecordTimestamp() {
        return LAST_UPDATE;
    }
    ...
    public CategoryTable rename(String name) {
        return new CategoryTable(DSL.name(name), null);
    }
     ...
     */
    @Override
    public CategoryTable rename(Name name) {
     ...
     */
    @Override
    public CategoryTable rename(Table<?> name) {
        return new CategoryTable(name.getQualifiedName(), null);
    }
     ...
     */
    @Override
    public CategoryTable where(Condition condition) {
        return new CategoryTable(getQualifiedName(), aliased() ? this : null, null, condition);
    }
     ...
     */
    @Override
    public CategoryTable where(Collection<? extends Condition> conditions) {
     ...
     */
    @Override
    public CategoryTable where(Condition... conditions) {
        return where(DSL.and(conditions));
    }
     ...
     */
    @Override
    public CategoryTable where(Field<Boolean> condition) {
    ...
    @Override
    @PlainSQL
    public CategoryTable where(SQL condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public CategoryTable where(@Stringly.SQL String condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public CategoryTable where(@Stringly.SQL String condition, Object... binds) {
    ...
    @Override
    @PlainSQL
    public CategoryTable where(@Stringly.SQL String condition, QueryPart... parts) {
     ...
     */
    @Override
    public CategoryTable whereExists(Select<?> select) {
     ...
     */
    @Override
    public CategoryTable whereNotExists(Select<?> select) {
