...
public class InventoryTable extends TableImpl<InventoryRecord> {
     ...
     */
    public static final InventoryTable INVENTORY = new InventoryTable();
    ...
    private InventoryTable(Name alias, Table<InventoryRecord> aliased) {
        this(alias, aliased, (Field<?>[]) null, null);
    }

    private InventoryTable(Name alias, Table<InventoryRecord> aliased, Field<?>[] parameters, Condition where) {
     ...
     */
    public InventoryTable(String alias) {
     ...
     * Create an aliased <code>sakila.inventory</code> table reference
     */
    public InventoryTable(Name alias) {
    ...
    public <O extends Record> InventoryTable(Table<O> path, ForeignKey<O, InventoryRecord> childPath, InverseForeignKey<O, InventoryRecord> parentPath) {
     ...
     */
    public static class InventoryPath extends InventoryTable implements Path<InventoryRecord> {
    ...
    @Override
    public TableField<InventoryRecord, LocalDateTime> getRecordTimestamp() {
        return LAST_UPDATE;
    }

    @Override
    public InventoryTable as(String alias) {
        return new InventoryTable(DSL.name(alias), this);
    }

    @Override
    public InventoryTable as(Name alias) {
        return new InventoryTable(alias, this);
    }

    @Override
    public InventoryTable as(Table<?> alias) {
        return new InventoryTable(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public InventoryTable rename(String name) {
        return new InventoryTable(DSL.name(name), null);
    }
     ...
     */
    @Override
    public InventoryTable rename(Name name) {
        return new InventoryTable(name, null);
    }
     ...
     */
    @Override
    public InventoryTable rename(Table<?> name) {
        return new InventoryTable(name.getQualifiedName(), null);
    }
     ...
     */
    @Override
    public InventoryTable where(Condition condition) {
        return new InventoryTable(getQualifiedName(), aliased() ? this : null, null, condition);
    }
     ...
     */
    @Override
    public InventoryTable where(Collection<? extends Condition> conditions) {
     ...
     */
    @Override
    public InventoryTable where(Condition... conditions) {
        return where(DSL.and(conditions));
    }
     ...
     */
    @Override
    public InventoryTable where(Field<Boolean> condition) {
    ...
    @Override
    @PlainSQL
    public InventoryTable where(SQL condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public InventoryTable where(@Stringly.SQL String condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public InventoryTable where(@Stringly.SQL String condition, Object... binds) {
    ...
    @Override
    @PlainSQL
    public InventoryTable where(@Stringly.SQL String condition, QueryPart... parts) {
     ...
     */
    @Override
    public InventoryTable whereExists(Select<?> select) {
     ...
     */
    @Override
    public InventoryTable whereNotExists(Select<?> select) {
