...
import org.northcoder.sakila.jooq.tables.FilmCategoryTable.FilmCategoryPath;
import org.northcoder.sakila.jooq.tables.InventoryTable.InventoryPath;
import org.northcoder.sakila.jooq.tables.LanguageTable.LanguagePath;
...
public class FilmTable extends TableImpl<FilmRecord> {
     ...
     */
    public final TableField<FilmRecord, String> RATING = createField(DSL.name("rating"), SQLDataType.VARCHAR(5).defaultValue(DSL.inline("G", SQLDataType.VARCHAR)), this, "");
    ...
    private FilmTable(Name alias, Table<FilmRecord> aliased) {
        this(alias, aliased, (Field<?>[]) null, null);
    }

    private FilmTable(Name alias, Table<FilmRecord> aliased, Field<?>[] parameters, Condition where) {
    ...
    public <O extends Record> FilmTable(Table<O> path, ForeignKey<O, FilmRecord> childPath, InverseForeignKey<O, FilmRecord> parentPath) {
     ...
     */
    public static class FilmPath extends FilmTable implements Path<FilmRecord> {
    ...
    @Override
    public TableField<FilmRecord, LocalDateTime> getRecordTimestamp() {
        return LAST_UPDATE;
    }

    @Override
    public FilmTable as(String alias) {
        return new FilmTable(DSL.name(alias), this);
    }

    @Override
    public FilmTable as(Name alias) {
        return new FilmTable(alias, this);
    }

    @Override
    public FilmTable as(Table<?> alias) {
        return new FilmTable(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public FilmTable rename(String name) {
        return new FilmTable(DSL.name(name), null);
    }
     ...
     */
    @Override
    public FilmTable rename(Name name) {
        return new FilmTable(name, null);
    }
     ...
     */
    @Override
    public FilmTable rename(Table<?> name) {
        return new FilmTable(name.getQualifiedName(), null);
    }
     ...
     */
    @Override
    public FilmTable where(Condition condition) {
        return new FilmTable(getQualifiedName(), aliased() ? this : null, null, condition);
    }
     ...
     */
    @Override
    public FilmTable where(Collection<? extends Condition> conditions) {
     ...
     */
    @Override
    public FilmTable where(Condition... conditions) {
        return where(DSL.and(conditions));
    }
     ...
     */
    @Override
    public FilmTable where(Field<Boolean> condition) {
    ...
    @Override
    @PlainSQL
    public FilmTable where(SQL condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public FilmTable where(@Stringly.SQL String condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public FilmTable where(@Stringly.SQL String condition, Object... binds) {
    ...
    @Override
    @PlainSQL
    public FilmTable where(@Stringly.SQL String condition, QueryPart... parts) {
     ...
     */
    @Override
    public FilmTable whereExists(Select<?> select) {
     ...
     */
    @Override
    public FilmTable whereNotExists(Select<?> select) {
